...
import { useColors, useCommon, useTheme } from '../../composables'
...
<template>
  ...
  >
    <div class="relative inline-block">
      ...
      <div
        v-if="show"
        class="absolute rounded-full z-10 bg-[color:var(--lu-badge-bg)]"
        :style="offsetStyle"
        :class="[
          positionClasses,
          {
      ...
      >
        <div
          v-if="animated"
          class="animate-ping opacity-75 absolute top-0 left-0 rounded-full h-full w-full z-10 bg-[color:var(--lu-badge-bg)]"
        />
        <div
