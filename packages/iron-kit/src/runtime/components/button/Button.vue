...
import { injectButtonGroupKey, useColors, useCommon, useInteractive, useTheme } from '../../composables'

import LuSpinner from '../spinner/Spinner.vue'
...
.button {
  color: var(--lu-button-text);
  background-color: var(--lu-button-bg);
  border-color: var(--lu-button-border);

  &--glow {
    box-shadow: 0 0 #000, 0 0 #000, 0 10px 15px -3px var(--lu-button-glow), 0 4px 6px -4px var(--lu-button-glow);
  }

  &:hover {
    color: var(--lu-button-text-hover, var(--lu-button-text));
    background-color: var(--lu-button-bg-hover, var(--lu-button-bg));
    border-color: var(--lu-button-border-hover, var(--lu-button-border));
  }

  &:active {
    color: var(--lu-button-text-active, var(--lu-button-text));
    background-color: var(--lu-button-bg-active, var(--lu-button-bg));
    border-color: var(--lu-button-border-active, var(--lu-button-border));
  }

  :global(.dark) &, &:global(.dark) {
    color: var(--lu-button-dark-text, var(--lu-button-text));
    background-color: var(--lu-button-dark-bg, var(--lu-button-bg));
    border-color: var(--lu-button-dark-border, var(--lu-button-border));

    &:hover {
      color: var(--lu-button-dark-text-hover, var(--lu-button-dark-text, var(--lu-button-text)));
      background-color: var(--lu-button-dark-bg-hover, var(--lu-button-dark-bg, var(--lu-button-bg)));
      border-color: var(--lu-button-dark-border-hover, var(--lu-button-dark-border, var(--lu-button-border)));
    }

    &:active {
      color: var(--lu-button-dark-text-active, var(--lu-button-dark-text));
      background-color: var(--lu-button-dark-bg-active, var(--lu-button-dark-bg, var(--lu-button-bg)));
      border-color: var(--lu-button-dark-border-active, var(--lu-button-dark-border, var(--lu-button-border)));
    }
  }
}
</style>
